...
document.querySelector(".Btnright").addEventListener('click', function(idx) {
    ...
    if( i == 1 ){
        ...
        $('.workTitle').html(`<a href="codeReview02.html" target="_blank">TOM HARDY <span id="viewmm">VIEW MORE -></span></a>`);
    ...
    if( i == 2 ){
        ...
        $('.workTitle').html(`<a href="codeReview03.html" target="_blank">JEJU MAP <span id="viewmm">VIEW MORE -></span></a>`);
    ...
    if( i == 3 ){
        ...
        $('.workTitle').html(`<a href="codeReview04.html" target="_blank">SEE : SAW <span id="viewmm">VIEW MORE -></span></a>`);
    ...
    if( i == 4 ){
        ...
        $('.workTitle').html(`<a href="codeReview05.html" target="_blank">MANG-O <span id="viewmm">VIEW MORE -></span></a>`);
    ...
    if( i == 5 ){
        ...
        $('.workTitle').html(`<a href="codeReview06.html" target="_blank">PUBG : BATTLEGROUND DESTON <span id="viewmm">VIEW MORE -></span></a>`);
...
document.querySelector(".BtnLeft").addEventListener('click', function(idx) {
    ...
    if( i == 0 ){
        ...
        $('.workTitle').html(`<a href="codeReview01.html" target="_blank">PORTFOLIO WORK <span id="viewmm">VIEW MORE -></span></a>`);
